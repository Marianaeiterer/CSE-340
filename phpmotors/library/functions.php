...
function buildVehicleInformationDisplay($vehicleDetails, $vehicleThumbnails)
{
    ...
    foreach ($vehicleDetails as $vehicleDetail) {
        ...
        $dv .= "</div>";
        $dv .= "<div>";
        $dv .= "<p>Price: $" . number_format($vehicleDetail['invPrice']);
        $dv .= "</p>";
        ...
        $dv .= "</div>";
        $dv .= "</div>";
        $dv .= '<ul class="thumbnail">';

        foreach ($vehicleThumbnails as $vehicleThumbnail) {
            $dv .= '<li>';
            $dv .=  "<img src='$vehicleThumbnail[invThumbnail]' alt='$vehicleThumbnail[invMake] $vehicleThumbnail[invModel] image on PHP Motors.com'>";
            $dv .=  '</li>';
        }
        $dv .=   '</ul>';
        $dv .= "</div>";
